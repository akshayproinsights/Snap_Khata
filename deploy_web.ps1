...
gcloud run deploy snap-khata-backend --source . --region asia-south1 --allow-unauthenticated --project digientry-prod --quiet
...
Set-Location -Path "c:\Users\MSi\Documents\Superbase\frontend"
