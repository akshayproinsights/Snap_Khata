...
class UdharListPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Udhar (Credit) Tracking'),
        actions: [
          IconButton(
        ...
        child: Row(
          children: [
            Container(
              ...
              child: Center(
                child: Text(
                  ledger.customerName.isNotEmpty ? ledger.customerName[0].toUpperCase() : 'U',
                  style: TextStyle(
                    fontSize: 20,
                    fontWeight: FontWeight.bold,
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  if (ledger.customerPhone != null && ledger.customerPhone!.isNotEmpty) ...[
