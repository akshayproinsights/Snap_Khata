...
/// Persists the active inventory upload task ID to disk so it can survive app kills.
/// Written when processing starts, cleared when processing ends (success/fail).
///
...
class InventoryPersistenceService {
  static const String _taskIdKey = 'inventory_active_task_id';
  static const String _fileCountKey = 'inventory_active_file_count';
  static const String _startedAtKey = 'inventory_started_at_ms';

  // ── Upload-phase keys (pre-task-id) ──
  static const String _uploadPhaseKey = 'inventory_upload_phase_active';
  static const String _uploadPhaseFilesKey =
      'inventory_upload_phase_file_paths';
  static const String _uploadPhaseStartedKey =
      'inventory_upload_phase_started_at_ms';
  ...
  /// Returns true if the app was killed mid-upload.
